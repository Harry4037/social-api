...
async function main() {
  ...
  const pack = await prisma.challenge.upsert({
    where:  { id: 'seed-challenge-pack-001' },
    update: {},
    create: {
      id:                 'seed-challenge-pack-001',
  ...
  const solo = await prisma.challenge.upsert({
    where:  { id: 'seed-challenge-solo-001' },
    update: {},
    create: {
      id:          'seed-challenge-solo-001',
      title:       'Morning 30',
  ...
  const duel = await prisma.challenge.upsert({
    where:  { id: 'seed-challenge-duel-001' },
    update: {},
    create: {
      id:          'seed-challenge-duel-001',
      title:       'The Duel',
